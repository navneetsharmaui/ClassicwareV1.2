...
$page_title = 'Moradabd Brass Utensils Details';
...
<div class="cont span_2_of_3">
	  <div class="labout span_1_of_a1">
			<div class="flexslider">
					  <ul class="slides">
						<li data-thumb="/sandbox/ecommerce/images/moradabadbrassutensil1.jpg">
							<div class="thumb-image"> <img src="/sandbox/ecommerce/images/moradabadbrassutensil1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="/sandbox/ecommerce/images/moradabadbrassutensil2.jpg">
							 <div class="thumb-image"> <img src="/sandbox/ecommerce/images/moradabadbrassutensil2.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="/sandbox/ecommerce/images/moradabadutensil1.jpg">
						   <div class="thumb-image"> <img src="/sandbox/ecommerce/images/moradabadutensil1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="/sandbox/ecommerce/images/moradabadutensil2.jpg">
						   <div class="thumb-image"> <img src="/sandbox/ecommerce/images/moradabadutensil2.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
					  </ul>
	...
	<div class="cont1 span_2_of_a1">
		<h3 class="m_3">Moradabad Brass Utensils</h3>
		
		<div class="price_single">
					  <span class="reducedfrom"><i class="fa fa-inr"></i> 500.00</span>
		...
		<p class="m_desc">As our range of products belongs to catering & serving food in style we offer maharaja style Thali in Copper Steel with 12"dia, which houses 4 Veg Bowls, 1 Chutney Bowl, 1 Rice Bowl, 1 Glass, 1 AP Spoon & 1 AP Fork.</p>
...
<div class="toogle">
	...
	<p class="m_text">As our range of products belongs to catering & serving food in style we offer maharaja style Thali in Copper Steel with 12"dia, which houses 4 Veg Bowls, 1 Chutney Bowl, 1 Rice Bowl, 1 Glass, 1 AP Spoon & 1 AP Fork.</p>
    <p class="m_text"> The fusion of Copper & Steel is so seamless that it is hardly visible from where they originate.</p>
</div>					
<div class="toogle">
	<h3 class="m_3">Product Reviews</h3>
	<p class="m_text">“good place for buying Shawls”</p>
	<p class="m_text">I have always liked Utensils and it is the best place to buy it.</p>
</div>
</div>
<div class="clear"></div>
</div>
