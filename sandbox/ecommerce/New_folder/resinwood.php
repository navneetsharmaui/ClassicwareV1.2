...
$page_title = 'Bareilly Resin WoodWork Details';
...
<div class="cont span_2_of_3">
	  <div class="labout span_1_of_a1">
			<div class="flexslider">
					  <ul class="slides">
						<li data-thumb="/sandbox/ecommerce/images/resinwood1.jpg">
							<div class="thumb-image"> <img src="/sandbox/ecommerce/images/resinwood1.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="/sandbox/ecommerce/images/resinwood2.jpg">
							 <div class="thumb-image"> <img src="/sandbox/ecommerce/images/resinwood2.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="/sandbox/ecommerce/images/resinwood3.jpg">
						   <div class="thumb-image"> <img src="/sandbox/ecommerce/images/resinwood3.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						<li data-thumb="/sandbox/ecommerce/images/resinwood4.jpg">
						   <div class="thumb-image"> <img src="/sandbox/ecommerce/images/resinwood4.jpg" data-imagezoom="true" class="img-responsive"> </div>
						</li>
					  </ul>
	...
	<div class="cont1 span_2_of_a1">
		<h3 class="m_3">Bareilly Resin WoodWork</h3>
		
		<div class="price_single">
					  <span class="reducedfrom"><i class="fa fa-inr"></i> 2000.00</span>
					  <span class="actual"><i class="fa fa-inr"></i> 1000.00</span>
					</div>
		<div class="btn_form">
		   <form>
			 <a href="/sandbox/ecommerce/classicware_cart/index.php/shopping" target="_blank"><input type="submit" value="buy now" title="Add to cart"></a>
		  </form>
		</div>
...
<div class="toogle">
	...
	<p class="m_text">I have always liked pasmina shawls and it is the best place to buy it.</p>
</div>
</div>
<div class="clear"></div>
</div>
